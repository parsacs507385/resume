...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for i in range(cell[0]-1, cell[0]+2):
            for j in range(cell[1]-1, cell[1]+2):
                ...
                if 0 <= i < self.height and 0 <= j < self.width:
                    newSenCells.add((i, j))
        self.knowledge.append(Sentence(newSenCells, count))
        ...
        while knowledgeChanged:
            ...
            for sen1 in self.knowledge:
                for sen2 in self.knowledge:
                    if sen1.cells == sen2.cells:
                        continue
                    if sen1.cells == set() and sen1.count > 0:
                        raise ValueError

                    if sen1.cells.issubset(sen2.cells):
                        newSenCells = sen2.cells - sen1.cells
                        newSenCount = sen2.count - sen1.count

                        newSen = Sentence(newSenCells, newSenCount)
    ...
    def make_random_move(self):
        ...
        if moves and not self.knowledge:
            ...
            bestProbability = moveList[0][1]

            best_moves = [x for x in moveList if x[1] == bestProbability]
